...
/// Multiple input, single output
// fold_left_v_ : 
BOOST_TMP_EXPORT template <typename F = listify_v_, typename C = identity_>
struct fold_left_v_ {};
namespace impl { // fold_left_v_
    template <template <typename, auto...> class F, template <typename...> class C>
    ...
    struct dispatch<N, fold_left_v_<F, C>>
        : dispatch<N, fold_left_v_<lift_v_<dispatch<2, F>::template f>,
                                    lift_<dispatch<1, C>::template f>>> {};
    ...
    struct dispatch<N, fold_left_v_<F, lift_<C>>>
        : dispatch<N, fold_left_v_<lift_<dispatch<2, F>::template f>, lift_<C>>> {};
